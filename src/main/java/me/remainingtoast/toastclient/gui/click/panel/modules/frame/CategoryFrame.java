...
public class CategoryFrame extends Frame {
    ...
    public void drawScreen(int x, int y, float partialTicks) {
        ...
        RenderUtil.drawRect2(getX(), getY(), getW(), getH() + moduleManager.getModulesInCat(moduleCategory).size() * 10 + 5, 0xff050505);
        RenderUtil.drawBorderedRect2(getX() + .5f, getY() + .5f, getW() - 1f, getH() - 1f + moduleManager.getModulesInCat(moduleCategory).size() * 10 + 5, 0.5f, 0xff282828, 0xff282828);
        RenderUtil.drawBorderedRect2(getX() + 1.5f, getY() + 1.5f, getW() - 3f, getH() - 3f + moduleManager.getModulesInCat(moduleCategory).size() * 10 + 5, 0.5f, 0xff111111, 0xff3C3C3C);
